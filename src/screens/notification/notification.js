    ...
    function renderComplain({item}){
        return (
            ...
            style={{...styles.itemCon}}>
                <View style={{width:'25%',justifyContent:'center',alignItems:'center',backgroundColor:colors.thm,height:responsiveHeight(13),borderTopLeftRadius:responsiveFontSize(0.5),borderBottomLeftRadius:responsiveFontSize(0.5)}}>
                    <NotiIcon
                    name="notifications"
                ...
                <View style={{width:"55%",padding:responsiveFontSize(1)}}>
