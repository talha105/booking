...
function BigModel({visible,closeModle,title,des}){
    ...
    return (
        ...
        >
            <View style={{flex:1,justifyContent:'center',alignItems:'center',height:height,backgroundColor:'rgba(0,0,0,0.7)'}}>
                <View style={{...styles.con,backgroundColor:'#ececec'}}>
                    ...
                    <ScrollView style={{flex:4,width:'90%',paddingTop:10}}>
                        ...
                        <Text style={{color:'gray',textAlign:"justify",fontSize:12,marginTop:responsiveFontSize(1.5),backgroundColor:'white',padding:responsiveFontSize(1),borderRadius:7,minHeight:responsiveHeight(50)}}>{des}</Text>
                    </ScrollView>
                </View>
            </View>
        </Modal>
