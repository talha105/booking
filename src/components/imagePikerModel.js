    ...
    return (
        ...
        >
            <View style={{flex:1,justifyContent:'center',alignItems:'center',height:height,backgroundColor:'rgba(0,0,0,0.7)'}}>
                ...
                <View style={{...styles.btn,backgroundColor:colors.thm}}>
                        <TouchableOpacity
                    ...
                    <View style={{flex:1,flexDirection:'row',justifyContent:'space-around',width:'100%',alignItems:'center'}}>
                        <TouchableOpacity 
                        onPress={()=>goToCamera()}
                        style={{marginLeft:responsiveWidth(5),width:responsiveWidth(22),height:responsiveWidth(22),borderRadius:7,borderColor:colors.thm,borderWidth:3,justifyContent:'center',alignItems:'center'}}>
                        <CameraIcon
                        ...
                        <TouchableOpacity 
                        onPress={()=>goToGallery()}
                        style={{marginRight:responsiveWidth(5),width:responsiveWidth(22),height:responsiveWidth(22),borderRadius:7,borderColor:colors.thm,borderWidth:3,justifyContent:'center',alignItems:'center'}}>
                        <GalleryIcon
                        size={responsiveScreenFontSize(6)}
                        color={colors.thm}
                        name="photo"
